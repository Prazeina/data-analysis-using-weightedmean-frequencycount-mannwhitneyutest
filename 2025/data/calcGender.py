...
df = pd.read_csv('/Users/prazeina/Documents/repos/RS/2025/data/testData/2025 - Rank -Gender.csv')
...
gender_rank_freq['F'].to_csv('/Users/prazeina/Documents/repos/RS/2025/data/result/female_ranking_frequency.csv', index=True)
gender_rank_freq['M'].to_csv('/Users/prazeina/Documents/repos/RS/2025/data/result/male_ranking_frequency.csv', index=True)

# ------------------------------------------------------------------------------------------------------------------------------------------------

# Load the dataset
file_path = "/Users/prazeina/Documents/repos/RS/2025/data/testData/2025 - Confidence Gender.csv"  
...
df_g = df[df[level_col] == 'F']
df_u = df[df[level_col] == 'M']
...
g_counts.to_csv('/Users/prazeina/Documents/repos/RS/2025/data/result/confidence_f_frequency_counts.csv')
u_counts.to_csv('/Users/prazeina/Documents/repos/RS/2025/data/result/confidence_m_frequency_counts.csv')

# ------------------------------------------------------------------------------------------------------------------------------------------------

# Load the dataset
file_path = "/Users/prazeina/Documents/repos/RS/2025/data/result/confidence_f_frequency_counts.csv" 
df = pd.read_csv(file_path)
...
result_df.to_csv('/Users/prazeina/Documents/repos/RS/2025/data/result/f_processed_mean_values.csv', index=False)

# ------------------------------------------------------------------------------------------------------------------------------------------------

# Load the dataset
file_path = "/Users/prazeina/Documents/repos/RS/2025/data/result/confidence_m_frequency_counts.csv" 
df = pd.read_csv(file_path)
...
# Save the new data with calculated means to a new CSV file
result_df.to_csv('/Users/prazeina/Documents/repos/RS/2025/data/result/m_processed_mean_values.csv', index=False)
