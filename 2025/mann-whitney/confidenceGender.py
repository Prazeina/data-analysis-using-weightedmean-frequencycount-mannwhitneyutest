...
# Load the CSV files 
graduates_data_new = pd.read_csv('/Users/prazeina/Documents/repos/RS/2025/mann-whitney/testFiles/f_processed_mean_values.csv', index_col=0)
undergraduates_data_new = pd.read_csv('/Users/prazeina/Documents/repos/RS/2025/mann-whitney/testFiles/m_processed_mean_values.csv', index_col=0)
...
# Save to CSV
results_df.to_csv('/Users/prazeina/Documents/repos/RS/2025/mann-whitney/result/gender_confidence_mannWhitneyU_results.csv', index=False)
...
# Save the Excel file
excel_output_file_path = '/Users/prazeina/Documents/repos/RS/2025/mann-whitney/result/gender_confidence_mannWhitneyU_results.xlsx'
...
# Read the Excel file
df = pd.read_excel(
    "/Users/prazeina/Documents/repos/RS/2025/mann-whitney/result/gender_confidence_mannWhitneyU_results.xlsx",
    sheet_name="Results",
    header=None
)
...
# Export as image
dfi.export(df_styled, "/Users/prazeina/Documents/repos/RS/2025/mann-whitney/result/2025 Confidence Gender.png", dpi=300)

# ------------------------------------------------------------------------------------------------------------------------------
# import matplotlib.pyplot as plt

# # Load the dataset
# df = pd.read_csv("/Users/prazeina/Documents/repos/RS/2025/mann-whitney/result/gender_confidence_mannWhitneyU_results.csv")
...
# plt.ylabel('Skill')
# plt.title('2025 - Weighted Mean self-assessment of skills by Gender\n(Lower = More Important)')
