...
# Load the CSV files
graduates_data = pd.read_csv('/Users/prazeina/Documents/repos/RS/2025/mann-whitney/testFiles/graduate_ranking_frequency.csv', index_col=0)
undergraduates_data = pd.read_csv('/Users/prazeina/Documents/repos/RS/2025/mann-whitney/testFiles/undergradaute_ranking_frequency.csv', index_col=0)
...
results_df.to_csv('/Users/prazeina/Documents/repos/RS/2025/mann-whitney/result/level_rank_mannWhitneyU_results.csv', index=False)
...
# Save the Excel file
excel_output_file_path = '/Users/prazeina/Documents/repos/RS/2025/mann-whitney/result/level_rank_mannWhitneyU_results.xlsx'
...
# Read the Excel file
df = pd.read_excel(
    "/Users/prazeina/Documents/repos/RS/2025/mann-whitney/result/level_rank_mannWhitneyU_results.xlsx",
    sheet_name="Results",
    header=None
)
...
# Export as image
dfi.export(df_styled, "/Users/prazeina/Documents/repos/RS/2025/mann-whitney/result/2025 Rank Level.png", dpi=300)
...
# # Load the dataset
# df = pd.read_csv("/Users/prazeina/Documents/repos/RS/2025/mann-whitney/result/level_rank_mannWhitneyU_results.csv")
...
# plt.ylabel('Skill')
# plt.title('2025 - Weighted Mean Rank of Skills by Level\n(Lower = More Important)')
