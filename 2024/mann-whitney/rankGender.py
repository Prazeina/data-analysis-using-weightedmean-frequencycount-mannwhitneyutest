...
# Load the CSV files
graduates_data = pd.read_csv('/Users/prazeina/Documents/repos/RS/2024/mann-whitney/testFiles/female_ranking_frequency.csv', index_col=0)
undergraduates_data = pd.read_csv('/Users/prazeina/Documents/repos/RS/2024/mann-whitney/testFiles/male_ranking_frequency.csv', index_col=0)
...
for skill in skills:
    ...
    results['Median_Female'].append(median_grad)
    results['Median_Male'].append(median_undergrad)
    ...
    results['Sample_Size_Female'].append(n_grad)
    results['Sample_Size_Male'].append(n_undergrad)
...
# Save to CSV
results_df.to_csv('/Users/prazeina/Documents/repos/RS/2024/mann-whitney/result/gender_rank_mannWhitneyU_results_all.csv', index=False)
# ---------------------------------------------------------------------------------------------------------------------------------------
...
output_df = pd.DataFrame({
    ...
    'Female_Median': results_df['Median_Female'],
    'Female_N': results_df['Sample_Size_Female'],
    'Male_Median': results_df['Median_Male'],
    'Male_N': results_df['Sample_Size_Male'],
...
# Save the Excel file
excel_output_file_path = '/Users/prazeina/Documents/repos/RS/2024/mann-whitney/result/gender_rank_mannWhitneyU_results.xlsx'
...
# Read the Excel file
df = pd.read_excel(
    "/Users/prazeina/Documents/repos/RS/2024/mann-whitney/result/gender_rank_mannWhitneyU_results.xlsx",
    sheet_name="Results",
    header=None
)
...
# Export as image
dfi.export(df_styled, "/Users/prazeina/Documents/repos/RS/2024/mann-whitney/result/2024 Rank Gender.png", dpi=300)
