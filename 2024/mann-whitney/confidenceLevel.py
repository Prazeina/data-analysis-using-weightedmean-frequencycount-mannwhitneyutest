...
# Load the CSV files (replace with your actual file paths if needed)
graduates_data_new = pd.read_csv('/Users/prazeina/Documents/repos/RS/2024/mann-whitney/testFiles/graduate_confidence_frequency.csv', index_col=0)
undergraduates_data_new = pd.read_csv('/Users/prazeina/Documents/repos/RS/2024/mann-whitney/testFiles/undergraduate_confidence_frequency.csv', index_col=0)
...
# Save to CSV
results_df.to_csv('/Users/prazeina/Documents/repos/RS/2024/mann-whitney/result/level_confidence_mannWhitneyU_results_all.csv', index=False)
...
# Save the Excel file
excel_output_file_path = '/Users/prazeina/Documents/repos/RS/2024/mann-whitney/result/level_confidence_mannWhitneyU_results.xlsx'
wb.save(excel_output_file_path)
# --------------------------------------------------------------------------------

# Read the Excel file
df = pd.read_excel(
    "/Users/prazeina/Documents/repos/RS/2024/mann-whitney/result/level_confidence_mannWhitneyU_results.xlsx",
    sheet_name="Results",
    header=None
)
...
# Export as image
dfi.export(df_styled, "/Users/prazeina/Documents/repos/RS/2024/mann-whitney/result/2024 Confidence Level.png", dpi=300)
...
# # Load the dataset
# df = pd.read_csv("/Users/prazeina/Documents/repos/RS/2024/mann-whitney/result/level_confidence_mannWhitneyU_results.csv")
...
# plt.ylabel('Skill')
# plt.title('2024 - Weighted Mean self-assessment of skills by Level\n(Lower = More Important)')
